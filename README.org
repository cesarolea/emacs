...
(defun my/font-config ()
  ...
  ;; Font configuration
  (set-face-attribute 'default nil :font "IBM Plex Mono" :height (if (equal system-type 'darwin) 170 110) :weight 'regular)

  ;; Set the fixed pitch face
  (set-face-attribute 'fixed-pitch nil :font "IBM Plex Mono" :height (if (equal system-type 'darwin) 170 120))
