...
#+begin_src emacs-lisp
  (use-package org-roam
    ...
    (setq org-roam-completion-system 'ivy
          ...
          org-roam-dailies-directory "~/Sync/org/roam/dailies/"
          org-roam-dailies-capture-templates
          '(("d" "default" entry
             #'org-roam-capture--get-point
             "* %?"
             :file-name "~/Sync/org/roam/dailies/%<%Y-%m-%d>"
             :head "#+title: %<%Y-%m-%d>\n\n"))
...
#+begin_src emacs-lisp
  (use-package mu4e
    ...
    (setq mu4e-change-filenames-when-moving t
          ...
          mu4e-get-mail-command "mbsync loanpro"
          mu4e-maildir "~/Mail"
          ...
          (list
           (make-mu4e-context
            ...
            :vars '((user-mail-address . "cesar.olea@loanpro.io")
                    ...
                    (mu4e-compose-signature . "<#part type=text/html>
  <html><body><div style=\"line-height:1.2em;color:#27313f;font-family:roboto,sans-serif;font-size:0.9em\">
    <div style=\"padding-bottom:3px\">
      <a href=\"https://www.linkedin.com/in/cesarolea/\" style=\"color:rgb(39,49,63);font-weight:bold\" target=\"_blank\">CESAR OLEA</a>&nbsp;|
    ...
    <a href=\"https://loanpro.io/\" target=\"_blank\">
      <img alt=\"LoanPro\" src=\"https://loanpro.io/wp-content/uploads/2020/07/cropped-new-logo-2-1.png\" style=\"max-width:120px;margin-top:8px\">
      </a>
    </div>
  </body></html><#/part>")
           ...
           (make-mu4e-context
            ...
            :vars '((user-mail-address . "cesarolea@gmail.com")
                    (user-full-name . "César Olea")
                    (mu4e-drafs-folder . "/personal/[Gmail]/Drafts")
                    (mu4e-sent-folder . "/personal/[Gmail]/Sent Mail")
                    (mu4e-refile-folder . "/personal/[Gmail]/All Mail")
                    (mu4e-trash-folder . "/personal/[Gmail]/Trash")
                    (mu4e-attachment-dir . "~/Downloads/mail-attachments/personal")
                    (mu4e-compose-signature . "César Olea")
                    (smtpmail-smtp-server . "smtp.gmail.com")
                    (smtpmail-smtp-service . 465)
                    (smtpmail-stream-type . ssl)
                    (smtpmail-smtp-user . "cesarolea@gmail.com")
                    (mu4e-sent-messages-behavior . delete)))))
    ...
    (setq mu4e-bookmarks
          '(("maildir:\"/loanpro/Inbox\" AND NOT flag:trashed"              "LoanPro Inbox"           ?p)
            ...
            ("maildir:\"/personal/[Gmail]/All Mail\" AND NOT flag:trashed"  "Personal Inbox"          ?l)
            ("mime:application/pdf AND NOT flag:trashed"                    "Messages with PDF files" ?P)
            ("flag:unread AND NOT flag:trashed"                             "Unread messages"         ?i)
            ("date:today..now AND NOT flag:trashed"                         "Today's messages"        ?t)
            ("date:today..nod AND maildir:\"/loanpro/[Gmail]/Sent Mail\""   "Sent messages"           ?s))))
  ...
  (use-package mu4e-alert
    ...
    (setq mu4e-alert-interesting-mail-query
        (concat
         ...
         " AND NOT (maildir:\"/loanpro/[Gmail]/All Mail\" OR maildir:\"/personal/[Gmail]/All Mail\")")))
#+end_src
