...
:END:" :empty-lines 1 :immediate-finish t)
  ...
  (setq org-default-notes-file "~/Sync/Org/refile.org"
        org-agenda-files '("~/Sync/Org/life.org"
                           "~/Sync/Org/Mail.org"
                           "~/Sync/Org/work.org"
                           "~/Simnang/org/weekly-check-in.org")
...
(use-package mu4e
  ...
  <p style=\"font-family:Helvetica,Arial,sans-serif;font-size:13px;line-height:10px;color:rgb(39,49,63)\">(662) 172 5478&nbsp;|&nbsp;<a>cesar.olea@loanpro.io</a>
  </p>
