...
#+begin_src emacs-lisp
  (use-package which-key
    :init (which-key-mode)
    :bind ("H-s-w" . which-key-show-major-mode)
...
*** TODO Documentation
 ...
 #+begin_src emacs-lisp
   ...
   (use-package helm :pin melpa
     ...
     (global-set-key (kbd "H-s-b") 'helm-bookmarks)
...
#+begin_src emacs-lisp
  (use-package org
    ...
    (define-key org-mode-map (kbd "H-s-u") #'org-goto)
    (define-key org-mode-map (kbd "H-s-U") #'org-mark-ring-goto)
    (define-key org-mode-map (kbd "H-s-l") #'org-toggle-link-display)
    (define-key org-mode-map (kbd "H-s-i") #'org-toggle-inline-images)
...
#+begin_src emacs-lisp
  (use-package org-roam
    ...
    (setq org-roam-completion-system 'ivy
          ...
          org-roam-dailies-directory "~/Sync/roam/dailies/"
          org-roam-dailies-capture-templates
          '(("d" "default" entry
             #'org-roam-capture--get-point
             "* %?"
             :file-name "~/Sync/roam/dailies/%<%Y-%m-%d>"
             :head "#+title: %<%Y-%m-%d>\n\n"))
          org-roam-graph-exclude-matcher '("dailies"))
    (require 'org-roam-protocol)
    :custom (org-roam-directory "~/Sync/roam/")
