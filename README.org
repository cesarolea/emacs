...
(use-package org
  ...
  (setq org-capture-templates
        '(("w" "Work Workflow")
          ("wt" "Task" entry (file+olp "~/Sync/Org/work.org.gpg" "To Do")
           "* TODO %?\n  ADDED: %t\n\n%i" :empty-lines 1)
          ("wr" "Refile" entry (file+olp "~/Sync/Org/work.org.gpg" "Refile")
           "* TODO %?\n  ADDED: %t\n\n%i" :empty-lines 1)
...
:END:" :empty-lines 1 :immediate-finish t)
  ...
  (setq org-default-notes-file "~/Sync/Org/refile.org"
        org-agenda-files '("~/Sync/Org/life.org.gpg"
                           "~/Sync/Org/Mail.org"
                           "~/Sync/Org/work.org.gpg"
                           "~/Simnang/org/weekly-check-in.org.gpg")
