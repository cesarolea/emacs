...
(defun my/font-config ()
  ...
  ;; Set the symbol face
  ;; (set-face-attribute 'org-modern-symbol nil :font "Iosevka NFM" :height (if (equal system-type 'darwin) 180 130))
  )
#+end_src
...
*** Theme
 ...
 (use-package nerd-icons :pin melpa)
...
(use-package ob-graphql :pin melpa)
